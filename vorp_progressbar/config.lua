...
Config.BlockedControls = {
    ...
    0x877F1027, -- INPUT_FRONTEND_NAV_LEFT
    0x86D773F6, -- INPUT_HORSE_MOVE_LEFT_ONLY
    0x07D1654C, -- INPUT_VEH_CAR_TURN_LEFT_ONLY
    0x198AFC64, -- INPUT_VEH_DRAFT_TURN_LEFT_ONLY
    0x5BED7C91, -- INPUT_VEH_BOAT_TURN_LEFT_ONLY
    0x9DF54706, -- INPUT_VEH_MOVE_LEFT_ONLY
    0x4CC0E2FE, -- INPUT_OPEN_SATCHEL_MENU
    0x5966D52A, -- INPUT_OPEN_SATCHEL_HORSE_MENU
    ...
    0x5B48F938, -- INPUT_FRONTEND_RRIGHT
    0x8E90C7BB, -- INPUT_QUIT
    0xE9094BA0, -- INPUT_MINIGAME_QUIT
    0x9959A6F0, -- INPUT_LOOK_BEHIND
    0x81280569, -- INPUT_HORSE_LOOK_BEHIND (while driving horse)
    0xA6C67243, -- INPUT_CINEMATIC_CAM_CHANGE_SHOT
    0xD8CF0C95, -- INPUT_CREATOR_RS
    0xCAE9B017, -- INPUT_VEH_LOOK_BEHIND (when driving vehicle)
    0xA6C67243, -- INPUT_CINEMATIC_CAM_CHANGE_SHOT (cinematic mode)
    0xD8CF0C95, -- INPUT_CREATOR_RS (cinematic mode)
    0x811F4A1A, -- INPUT_SECONDARY_SPECIAL_ABILITY_SECONDARY
    0xCEE12B50, -- INPUT_SPECIAL_ABILITY
    0x08BD758C, -- INPUT_FRONTEND_NAV_RIGHT
    0x4D8FB4C1, -- INPUT_MOVE_LR
    0xB4E465B4, -- INPUT_MOVE_RIGHT_ONLY
    0xF1111E4A, -- INPUT_SCRIPTED_FLY_LR
    0xFB56DD5B, -- INPUT_FRONTEND_AXIS_X
    0x3224BC55, -- INPUT_FRONTEND_SCROLL_AXIS_X
    0x3F4DC0EF, -- INPUT_CREATOR_DELETE
    0x4AF4D473, -- INPUT_FRONTEND_DELETE
    0x05CA7C52, -- INPUT_FRONTEND_DOWN
    0x4403F97F, -- INPUT_GAME_MENU_DOWN
    0x78114AB3, -- INPUT_FRONTEND_NAV_DOWN
    0x21651AD6, -- INPUT_FRONTEND_SCROLL_AXIS_Y
    0x126796EB, -- INPUT_HORSE_MOVE_LR
    0x7E6B8612, -- INPUT_HORSE_MOVE_RIGHT_ONLY
    0x3BD38D43, -- INPUT_VEH_CAR_TURN_LR
    0x5E371EA7, -- INPUT_VEH_DRAFT_TURN_RIGHT_ONLY
    0x6E3C3649, -- INPUT_VEH_CAR_TURN_RIGHT_ONLY
    0x97A8FD98, -- INPUT_VEH_MOVE_RIGHT_ONLY
    0xA7DFAE8A, -- INPUT_VEH_DRAFT_TURN_LR
    0xD8DFCAB3, -- INPUT_VEH_BOAT_TURN_LR
    0xF1E2852C, -- INPUT_VEH_MOVE_LR
    0xF9780DFB, -- INPUT_VEH_BOAT_TURN_RIGHT_ONLY
    0x018C47CF, -- INPUT_MELEE_GRAPPLE_CHOKE
    0x110AD1D2, -- INPUT_GAME_MENU_TAB_RIGHT
    0x14DB6C5E, -- INPUT_LOOT_VEHICLE
    0x17BEC168, -- INPUT_FRONTEND_RB
    0x17D3BFF5, -- INPUT_INTERACT_LEAD_ANIMAL
    0x2277FAE9, -- INPUT_MELEE_GRAPPLE
    0x2EAB0795, -- INPUT_DYNAMIC_SCENARIO
    0x399C6619, -- INPUT_LOOT2
    0x41AC83D1, -- INPUT_LOOT
    0x43F2959C, -- INPUT_REVIVE
    0x5E723D8C, -- INPUT_SHOP_INSPECT
    0x91C9A817, -- INPUT_MELEE_GRAPPLE_REVERSAL
    0x97C71B28, -- INPUT_BREAK_VEHICLE_LOCK
    0x9BEE9213, -- INPUT_MAP_POI
    0x9FA5AD07, -- INPUT_INTERACT_LOCKON_ROB
    0xA4F1006B, -- INPUT_ARREST
    0xA95E1468, -- INPUT_HITCH_ANIMAL
    0xC75C27B0, -- INPUT_IGNITE
    0xCEFD9220, -- INPUT_ENTER
    0xD51B784F, -- INPUT_CONTEXT_Y
    0xDB8D69B8, -- INPUT_SURRENDER
    0xDFF812F9, -- INPUT_SHOP_BUY
    0xE2473BF0, -- INPUT_INTERACT_LOCKON_TRACK_ANIMAL
    0xF5C4701B, -- INPUT_INTERACT_LOCKON_DETACH_HORSE
    0xB99A9CAD, -- INPUT_CRAFTING_EAT
    0xCBDB82A8, -- INPUT_HORSE_EXIT
    0xFEFAB9B4, -- INPUT_VEH_EXIT
    0xE71F89B8, -- INPUT_RADIAL_MENU_SLOT_NAV_NEXT
    0x2CD5343E, -- INPUT_CREATOR_ACCEPT
    0x43DBF61F, -- INPUT_GAME_MENU_ACCEPT
    0x5734A944, -- INPUT_FRONTEND_RDOWN
    0xC7B5340A, -- INPUT_FRONTEND_ACCEPT
    0xCDC4E4E9, -- INPUT_SKIP_CUTSCENE
    ...
    0x3E89055A, -- INPUT_FRONTEND_KEYMAPPING_CANCEL (ESC)
    0x0522B243, -- INPUT_INTERACT_HIT_CARRIABLE
    0x26A18F47, -- INPUT_INTERACT_LOCKON_NEG
    0x3B24C470, -- INPUT_CONTEXT_B
    0x424BD2D2, -- INPUT_INTERACT_NEG
    0x6E9734E8, -- INPUT_CARRIABLE_SUICIDE
    0x7914A3DD, -- INPUT_STOP_LEADING_ANIMAL
    0xADEAF48C, -- INPUT_MELEE_GRAPPLE_ATTACK
    0xB2F377E8, -- INPUT_MELEE_ATTACK
    0xD2CC4644, -- INPUT_CUT_FREE
    0xD596CFB0, -- INPUT_GAME_MENU_EXTRA_OPTION
    0xD9C50532, -- INPUT_HOGTIE
    0xEA150E72, -- INPUT_SHOP_SPECIAL
    0xC67E13BB, -- INPUT_CAMP_BED_INSPECT
    0x4216AF06, -- INPUT_HORSE_COMMAND_FLEE (horse menu active)
    0x1A3EABBB, -- INPUT_HORSE_MELEE (when driving horse)
    0x1F6D95E5, -- INPUT_SELECT_ITEM_WHEEL
    0x35957F6C, -- INPUT_PHOTO_MODE_PC
    0x3C0A40F2, -- INPUT_PHOTO_MODE
    0x5415BE48, -- INPUT_INTERACT_LOCKON_ANIMAL
    0x760A9C6F, -- INPUT_INTERACT_OPTION1
    0xA1ABB953, -- INPUT_INTERACT_ANIMAL
    0x63A0D258, -- INPUT_VEH_HORN (when driving vehicle)
    0x24978A28, -- INPUT_WHISTLE
    0x73A8FD83, -- INPUT_SADDLE_TRANSFER
    0x84543902, -- INPUT_INTERACT_OPTION2
    0xC5CF41B2, -- INPUT_MULTIPLAYER_PREDATOR_ABILITY
    0xE7EB9185, -- INPUT_WHISTLE_HORSEBACK (when driving horse)
    0x064D1698, -- INPUT_FRONTEND_SOCIAL_CLUB
    0xC1989F95, -- INPUT_QUICK_USE_ITEM
    0xF3830D8E, -- INPUT_OPEN_JOURNAL
    0x80F28E95, -- INPUT_PLAYER_MENU
    0x580C4473, -- INPUT_HUD_SPECIAL
    0x8AAA0AD4, -- INPUT_PC_FREE_LOOK
    0xCF8A4ECA, -- INPUT_REVEAL_HUD
    0x0F39B3D4, -- INPUT_SELECT_RADAR_MODE
    0xE8342FF2, -- INPUT_MULTIPLAYER_INFO
    0x20190AB4, -- INPUT_DOCUMENT_PAGE_PREV
    0x877F1027, -- INPUT_FRONTEND_NAV_LEFT
    0xA65EBAB4, -- INPUT_FRONTEND_LEFT
    0xAD7FCC5B, -- INPUT_GAME_MENU_LEFT
    0x339F3730, -- INPUT_CREATOR_LS
    0x67ED272E, -- INPUT_MELEE_GRAPPLE_MOUNT_SWITCH
    0x9C5E030C, -- INPUT_SCRIPTED_FLY_ZDOWN
    0xD7DE6B1E, -- INPUT_FRONTEND_RUP
    0xDB096B85, -- INPUT_DUCK
    0x0B1BE2E8, -- INPUT_CAMP_SETUP_TENT
    0xE16B9AAD, -- INPUT_HORSE_STOP (when driving horse)
    0x2D79D80A, -- INPUT_VEH_HANDCART_BRAKE (when driving vehicle)
    0x428D5F39, -- INPUT_VEH_BOAT_BRAKE (when driving vehicle)
    0x65D24C98, -- INPUT_VEH_HANDBRAKE (when driving vehicle)
    0x6E1F639B, -- INPUT_VEH_BRAKE (when driving vehicle)
    0xD1887B3F, -- INPUT_VEH_CAR_BRAKE (when driving vehicle)
    0xD648E48D, -- INPUT_VEH_DRAFT_BRAKE (when driving vehicle)
    0x7C0162C0, -- INPUT_FRONTEND_Y
    0x8FFC75D6, -- INPUT_SPRINT
    0x639B9FC9, -- INPUT_SCRIPTED_FLY_ZUP
    0x5AA007D7, -- INPUT_HORSE_SPRINT (when driving horse)
    0x5B9FD4E2, -- INPUT_VEH_ACCELERATE (when driving vehicle)
    0x7232BAB3, -- INPUT_VEH_FLY_THROTTLE_UP (when driving vehicle)
    0xB341E812, -- INPUT_VEH_BOAT_ACCELERATE (when driving vehicle)
    0xB9F544B0, -- INPUT_VEH_CAR_ACCELERATE (when driving vehicle)
    0xE99D2B05, -- INPUT_VEH_DRAFT_ACCELERATE (when driving vehicle)
    0xFF3626FC, -- INPUT_VEH_HANDCART_ACCELERATE (when driving vehicle)
    0xE31C6A41, -- INPUT_MAP
    ...
    0x13C42BB2, -- INPUT_EMOTE_ACTION (MOUSE LEFT CLICK)
    0x1C559F2E,  -- INPUT_CURSOR_ACCEPT_DOUBLE_CLICK (MOUSE LEFT CLICK)
    ...
    0x04FB8191, -- INPUT_EMOTE_TWIRL_GUN_HOLD (MOUSE RIGHT CLICK)
    0x1E7D7275, -- INPUT_MELEE_MODIFIER (MOUSE RIGHT CLICK)
    0x27568539, -- INPUT_CURSOR_CANCEL (MOUSE RIGHT CLICK, fast)
    ...
    0xD45EC04F, -- INPUT_QUICK_SELECT_SET_FOR_SWAP (MOUSE RIGHT CLICK when wheel menu active)
    ...
    0x8AAA0AD4, -- INPUT_PC_FREE_LOOK (MOUSE SCROLL CLICK)
    ...
    0xF1301666, -- INPUT_VEH_HEADLIGHT (when driving vehicle)
    ...
    0xB238FE0B, -- INPUT_TOGGLE_HOLSTER (TAB, fast tapping)
    0xAC4BD4F1, -- INPUT_OPEN_WHEEL_MENU (TAB while holding)
    0x938D4071, -- INPUT_TWIRL_PISTOL (TAB if pressed fast twice)
    0x1C826362, -- INPUT_EMOTE_GROUP_LINK (TAB when action menu active, 1311.12)
    0x4FD1C57B, -- INPUT_EMOTE_GROUP_LINK_HORSE (TAB when action menu active, 1311.12)
    0xE2B557A3, -- INPUT_OPEN_EMOTE_WHEEL (TAB when action menu active, 1311.12)
    ...
    0xE72B43F4, -- INPUT_FOCUS_CAM (V when in cinematic mode)
